from Classification.entity.config_entity import DataIngestionConfig, DataValidationConfig,\
...
class Configuration:
    ...
    def get_data_ingestion_config(self) ->DataIngestionConfig:
        try:
            ...
            ingested_train_dirr = os.path.join(
                            ingested_data_dir,
                            data_ingestion_info[DATA_INGESTION_TRAIN_DIR_KEY]
                            )
            ingested_test_dirr = os.path.join(
                            ingested_data_dir,
